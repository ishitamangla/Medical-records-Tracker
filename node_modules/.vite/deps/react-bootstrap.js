...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-SWVFDRA7.js";
import {
  divWithClassName_default
} from "./chunk-DFVSQE74.js";
import {
  require_react_dom
} from "./chunk-6NCKM4JN.js";
import {
  Button_default as Button_default2
} from "./chunk-7TFI2TPD.js";
import {
  Button_default
} from "./chunk-KLQVHIKL.js";
import {
  DEFAULT_BREAKPOINTS,
...
var CardGroup = React15.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselCaption = React16.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function map(children, func) {
  let index = 0;
  return React18.Children.map(children, (child) => React18.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React18.Children.forEach(children, (child) => {
    if (React18.isValidElement(child)) func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return React18.Children.toArray(children).some((child) => React18.isValidElement(child) && child.type === type);
}
...
var Carousel = (
  ...
  React19.forwardRef(({
    ...
    const {
      ...
      onTouchMove,
      onTouchEnd,
      prevIcon = (0, import_jsx_runtime16.jsx)("span", {
        "aria-hidden": "true",
        className: "carousel-control-prev-icon"
      }),
      prevLabel = "Previous",
      nextIcon = (0, import_jsx_runtime16.jsx)("span", {
        "aria-hidden": "true",
    ...
    return (0, import_jsx_runtime17.jsxs)(Component2, {
      ref: elementRef,
      ...props,
      ...
      children: [indicators && (0, import_jsx_runtime16.jsx)("div", {
        className: `${prefix}-indicators`,
        children: map(children, (_, index) => (0, import_jsx_runtime16.jsx)("button", {
          type: "button",
          "data-bs-target": "",
        ...
        children: map(children, (child, index) => {
          ...
          return slide ? (0, import_jsx_runtime16.jsx)(TransitionWrapper_default, {
            in: isActive,
      ...
      }), controls && (0, import_jsx_runtime17.jsxs)(import_jsx_runtime18.Fragment, {
        children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime17.jsxs)(Anchor_default, {
          className: `${prefix}-control-prev`,
          onClick: prev,
          children: [prevIcon, prevLabel && (0, import_jsx_runtime16.jsx)("span", {
            className: "visually-hidden",
            children: prevLabel
          })]
        }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime17.jsxs)(Anchor_default, {
          className: `${prefix}-control-next`,
          onClick: next,
          children: [nextIcon, nextLabel && (0, import_jsx_runtime16.jsx)("span", {
            className: "visually-hidden",
            children: nextLabel
          })]
        })]
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react14.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react18.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context5 = (0, import_react23.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react24.useLayoutEffect : import_react24.useEffect;
...
var FormGroup = React51.forwardRef(({
  ...
  const context5 = (0, import_react33.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var Switch = React56.forwardRef((props, ref) => (0, import_jsx_runtime51.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Nav = React63.forwardRef((_ref, ref) => {
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react40.useRef)(false);
  const parentOnSelect = (0, import_react40.useContext)(SelectableContext_default);
  const tabContext = (0, import_react40.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react40.useRef)(null);
...
function useWillUnmount2(fn2) {
  ...
  (0, import_react43.useEffect)(() => () => onUnmount.current(), []);
}
...
function useRTGTransitionProps(_ref) {
  ...
  const nodeRef = (0, import_react46.useRef)(null);
  ...
  const handleEnter = (0, import_react46.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react46.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react46.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react46.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react46.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react46.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react46.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react46.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React66.forwardRef((_ref, ref) => {
  let {
...
function useTransition({
  ...
  const isInitialRef = (0, import_react47.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react47.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react47.cloneElement)(children, {
    ref: combinedRef
  });
}
...
var ModalBody = React69.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React70.createContext({
  onHide() {
  }
});
...
var AbstractModalHeader = React73.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context5 = (0, import_react49.useContext)(ModalContext_default);
...
var Modal2 = React76.forwardRef(({
  ...
  const renderBackdrop = (0, import_react50.useCallback)((backdropProps) => (0, import_jsx_runtime71.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React77.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react54.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react55.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React87.forwardRef(({
  ...
  const renderBackdrop = (0, import_react56.useCallback)((backdropProps) => (0, import_jsx_runtime82.jsx)("div", {
    ...backdropProps,
...
var Overlay2 = React98.forwardRef(({
  ...
  const [firstRenderedState, setFirstRenderedState] = (0, import_react62.useState)(null);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime99.jsxs)(import_jsx_runtime98.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react63.cloneElement)(children, triggerProps), (0, import_jsx_runtime97.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react65.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react66.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react66.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContent = React112.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React113.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React116.forwardRef((props, ref) => (0, import_jsx_runtime120.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React117.createContext({
  onClose() {
  }
});
...
var ToastHeader = React118.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context5 = (0, import_react67.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var ToastBody = React119.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React120.forwardRef(({
  ...
  const delayRef = (0, import_react68.useRef)(delay);
  const onCloseRef = (0, import_react68.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react68.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react68.useMemo)(() => ({
    onClose
  }), [onClose]);
...
var ToastContainer = React121.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React122.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React123.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
